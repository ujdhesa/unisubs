...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('teams_collaboration', (
        ...
        db.send_create_signal('teams', ['Collaboration'])

        # Adding model 'CollaborationHistory'
        db.create_table('teams_collaborationhistory', (
            ('collaborator2', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['teams.Collaborator'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('collaboration', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Collaboration'])),
            ('action', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('collaborator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['teams.Collaborator'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('teams', ['CollaborationHistory'])

        # Adding model 'Collaborator'
        db.create_table('teams_collaborator', (
            ('collaboration', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Collaboration'])),
            ('endorsement_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ...
        db.send_create_signal('teams', ['Collaborator'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Collaboration'
        db.delete_table('teams_collaboration')

        # Deleting model 'CollaborationHistory'
        db.delete_table('teams_collaborationhistory')

        # Deleting model 'Collaborator'
        db.delete_table('teams_collaborator')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 15, 18, 23, 12, 93355)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 15, 18, 23, 12, 93278)'}),
