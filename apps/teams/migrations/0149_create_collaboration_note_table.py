...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CollaborationNote'
        db.create_table('teams_collaborationnote', (
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('collaboration', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notes', to=orm['teams.Collaboration'])),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.CustomUser'])),
        ))
        db.send_create_signal('teams', ['CollaborationNote'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'CollaborationNote'
        db.delete_table('teams_collaborationnote')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 3, 11, 35, 58, 272995)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 3, 11, 35, 58, 272913)'}),
        ...
        'teams.collaborationnote': {
            'Meta': {'object_name': 'CollaborationNote'},
            'collaboration': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notes'", 'to': "orm['teams.Collaboration']"}),
