...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field shared_teams on 'Project'
        db.create_table('teams_project_shared_teams', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm['teams.project'], null=False)),
            ('team', models.ForeignKey(orm['teams.team'], null=False))
        ))
        db.create_unique('teams_project_shared_teams', ['project_id', 'team_id'])
    
    
    def backwards(self, orm):
        
        # Removing M2M table for field shared_teams on 'Project'
        db.delete_table('teams_project_shared_teams')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 15, 18, 21, 12, 992630)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 15, 18, 21, 12, 992553)'}),
        ...
        'teams.project': {
            ...
            'shared_teams': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'shared_projects'", 'symmetrical': 'False', 'to': "orm['teams.Team']"}),
