...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Team.workflow_style'
        db.add_column('teams_team', 'workflow_style', self.gf('django.db.models.fields.CharField')(default='N', max_length=1), keep_default=False)
    
        # Migrating data
        db.execute('UPDATE teams_team '
                   'SET workflow_style="T" '
                   'WHERE workflow_enabled')
    ...
    def backwards(self, orm):
        ...
        db.execute('UPDATE teams_team '
                   ...
                   'WHERE workflow_style="T"')

        # Deleting field 'Team.workflow_style'
        db.delete_column('teams_team', 'workflow_style')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 15, 18, 27, 51, 228567)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 15, 18, 27, 51, 228466)'}),
        ...
        'teams.team': {
            ...
            'workflow_style': ('django.db.models.fields.CharField', [], {'default': "'N'", 'max_length': '1'})
        },
