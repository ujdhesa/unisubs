...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CollaborationWorkflow'
        db.create_table('teams_collaborationworkflow', (
            ('only_1_reviewer', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
            ('on_complete_publish_all', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('on_complete_notify_managers', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('on_complete_publish_latest', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('only_1_subtitler', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('only_1_approver', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
            ('limit_open_tasks', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('completion_policy', self.gf('django.db.models.fields.CharField')(default='A', max_length=1)),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Team'], unique=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('teams', ['CollaborationWorkflow'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'CollaborationWorkflow'
        db.delete_table('teams_collaborationworkflow')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 15, 18, 30, 29, 737787)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 15, 18, 30, 29, 737709)'}),
