...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CollaborationLanguage'
        db.create_table('teams_collaborationlanguage', (
        ...
        db.send_create_signal('teams', ['CollaborationLanguage'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'CollaborationLanguage'
        db.delete_table('teams_collaborationlanguage')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 19, 9, 30, 33, 487284)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 19, 9, 30, 33, 487204)'}),
