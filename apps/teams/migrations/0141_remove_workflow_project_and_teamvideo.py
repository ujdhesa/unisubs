...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Workflow.team_video'
        db.delete_column('teams_workflow', 'team_video_id')

        # Deleting field 'Workflow.project'
        db.delete_column('teams_workflow', 'project_id')

        # Adding unique constraint on 'Workflow', fields ['team']
        db.create_unique('teams_workflow', ['team_id'])

    def backwards(self, orm):
        
        # Adding field 'Workflow.team_video'
        db.add_column('teams_workflow', 'team_video', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.TeamVideo'], null=True, blank=True), keep_default=False)

        # Adding field 'Workflow.project'
        db.add_column('teams_workflow', 'project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Project'], null=True, blank=True), keep_default=False)

        # Removing unique constraint on 'Workflow', fields ['team']
        db.delete_unique('teams_workflow', ['team_id'])

        # Adding unique constraint on 'Workflow', fields ['project', 'team_video', 'team']
        db.create_unique('teams_workflow', ['project_id', 'team_video_id', 'team_id'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 15, 18, 24, 58, 712416)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 15, 18, 24, 58, 712335)'}),
