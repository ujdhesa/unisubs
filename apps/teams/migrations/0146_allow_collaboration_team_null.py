...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Collaboration.team'
        db.alter_column('teams_collaboration', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Team'], null=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Collaboration.team'
        db.alter_column('teams_collaboration', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Team']))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 25, 10, 48, 43, 671636)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 25, 10, 48, 43, 671552)'}),
