...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Collaboration.project'
        db.add_column('teams_collaboration', 'project', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['teams.Project']), keep_default=False)
        db.execute("UPDATE teams_collaboration "
                   "SET project_id = ("
                   "SELECT project_id "
                   "FROM teams_teamvideo tv "
                   "WHERE tv.id = teams_collaboration.team_video_id)")

        # This index will help us quickly find collaborations to start
        db.create_index('teams_collaboration', ['state', 'project_id',
                                                'language_code'])
        # This index will help us quickly find collaborations to join
        db.create_index('teams_collaboration', ['team_id', 'state',
                                                'language_code'])
    ...
    def backwards(self, orm):
        ...
        # Deleting indexes
        db.delete_index('teams_collaboration', ['state', 'project_id',
                                                'language_code'])
        db.delete_index('teams_collaboration', ['team_id', 'state',
                                                'language_code'])

        # Deleting field 'Collaboration.project'
        db.delete_column('teams_collaboration', 'project_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 29, 15, 16, 32, 686049)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 29, 15, 16, 32, 685968)'}),
        ...
        'teams.collaborator': {
            ...
            'collaboration': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'collaborators'", 'to': "orm['teams.Collaboration']"}),
