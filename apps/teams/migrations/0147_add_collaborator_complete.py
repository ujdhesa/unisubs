...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Collaborator.complete'
        db.add_column('teams_collaborator', 'complete', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding index on 'Collaborator', fields ['complete']
        db.create_index('teams_collaborator', ['user_id', 'complete'])
    
    def backwards(self, orm):
        # Deleting index on 'Collaborator', fields ['complete']
        db.delete_index('teams_collaborator', ['user_id', 'complete'])
        
        # Deleting field 'Collaborator.complete'
        db.delete_column('teams_collaborator', 'complete')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 29, 15, 1, 11, 198801)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 29, 15, 1, 11, 198718)'}),
