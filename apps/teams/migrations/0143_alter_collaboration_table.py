...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Collaboration.last_joined'
        db.add_column('teams_collaboration', 'last_joined', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, db_index=True, blank=True), keep_default=False)

        # Adding field 'Collaboration.state'
        db.add_column('teams_collaboration', 'state', self.gf('django.db.models.fields.CharField')(default='s', max_length=1), keep_default=False)

        # Adding unique constraint on 'Collaboration', fields ['team_video', 'language_code']
        db.create_unique('teams_collaboration', ['team_video_id', 'language_code'])
    
    
    def backwards(self, orm):
        
        # Deleting field 'Collaboration.last_joined'
        db.delete_column('teams_collaboration', 'last_joined')

        # Deleting field 'Collaboration.state'
        db.delete_column('teams_collaboration', 'state')

        # Removing unique constraint on 'Collaboration', fields ['team_video', 'language_code']
        db.delete_unique('teams_collaboration', ['team_video_id', 'language_code'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 22, 13, 55, 17, 329575)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 22, 13, 55, 17, 329494)'}),
        ...
        'teams.collaboration': {
            'Meta': {'unique_together': "(('team_video', 'language_code'),)", 'object_name': 'Collaboration'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'last_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        'teams.collaborationhistory': {
            'Meta': {'object_name': 'CollaborationHistory'},
            'action': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'collaboration': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['teams.Collaboration']"}),
            'collaborator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['teams.Collaborator']"}),
            'collaborator2': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['teams.Collaborator']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'teams.collaborationlanguage': {
            'Meta': {'unique_together': "(('team', 'language_code'),)", 'object_name': 'CollaborationLanguage'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['teams.Project']", 'null': 'True', 'blank': 'True'}),
            'team': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['teams.Team']"})
        },
        'teams.collaborationworkflow': {
            'Meta': {'object_name': 'CollaborationWorkflow'},
            'completion_policy': ('django.db.models.fields.CharField', [], {'default': "'A'", 'max_length': '1'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'limit_open_tasks': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'on_complete_notify_managers': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'on_complete_publish_all': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'on_complete_publish_latest': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'only_1_approver': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
            'only_1_reviewer': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
            'only_1_subtitler': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
            'team': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['teams.Team']", 'unique': 'True'})
        },
        'teams.collaborator': {
            'Meta': {'object_name': 'Collaborator'},
            'collaboration': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['teams.Collaboration']"}),
            'endorsement_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teams.project': {
            ...
            'shared_teams': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'shared_projects'", 'blank': 'True', 'to': "orm['teams.Team']"}),
        ...
        'teams.taskworkflow': {
            'Meta': {'object_name': 'TaskWorkflow', 'db_table': "'teams_workflow'"},
        ...
        'teams.team': {
            ...
            'workflow_style': ('django.db.models.fields.CharField', [], {'default': "'D'", 'max_length': '1'})
        },
