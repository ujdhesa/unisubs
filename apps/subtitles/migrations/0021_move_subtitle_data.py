...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Subtitles'
        db.create_table('subtitles_subtitles', (
            ('serialized_subtitles', self.gf('django.db.models.fields.TextField')()),
            ('subtitle_version', self.gf('django.db.models.fields.related.OneToOneField')(related_name='subtitles', unique=True, primary_key=True, to=orm['subtitles.SubtitleVersion'])),
        ))
        db.send_create_signal('subtitles', ['Subtitles'])

        db.execute("INSERT INTO subtitles_subtitles"
                   "(subtitle_version_id, serialized_subtitles) "
                   "SELECT id, serialized_subtitles "
                   "FROM subtitles_subtitleversion")
 
        # Deleting field 'SubtitleVersion.serialized_subtitles'
        db.delete_column('subtitles_subtitleversion', 'serialized_subtitles')
    
    
    def backwards(self, orm):
        
        # Deleting model 'Subtitles'
        db.delete_table('subtitles_subtitles')

        # Adding field 'SubtitleVersion.serialized_subtitles'
        db.add_column('subtitles_subtitleversion', 'serialized_subtitles', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 19, 16, 12, 33, 96687)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 19, 16, 12, 33, 96589)'}),
        ...
        'subtitles.subtitles': {
            'Meta': {'object_name': 'Subtitles'},
            'serialized_subtitles': ('django.db.models.fields.TextField', [], {}),
            'subtitle_version': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'subtitles'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['subtitles.SubtitleVersion']"})
        },
